...
1. Make a list of 10 odd numbers.
2. Make a list of 10 strings.
3. Combine the above 2 lists, and assign the result to a variable.
4. Print the first 50 numbers, from 0 to 50.
...
8. Next, we'll learn conditional statements: i.e. if, else.
   - In your list of 10 strings, print every even-positioned item.
9. Kiss your  bf.